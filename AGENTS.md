...
| `fjallkartan/RemoteSettings.swift` | Remotely configurable tile URL templates (`TileSettings`: Lantmäteriet, Kartverket, elevation), fetched from `settings.json` with built-in fallbacks. |
